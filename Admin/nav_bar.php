			...
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right">Employee Attendance Management</p>
				</div>
				<div class = "nav navbar-nav navbar-right">
					<a href="logout.php" class="text-light"><?php echo $login_username_Admin ?> <i class="fa fa-power-off"></i></a>
				</div>
			</div>
		</nav>
		<div id="sidebar" class="bg-dark">
			...
			<div id="sidebar-field">
				<a href="Request.php" class="sidebar-item">
						<div class="sidebar-icon"><i class="fa fa-users"> </i></div>  Request
				</a>
			</div>
